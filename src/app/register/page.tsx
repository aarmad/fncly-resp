        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center p-6 transition-colors duration-500">
            <div className="w-full max-w-lg bg-white dark:bg-slate-800 p-10 rounded-[3rem] shadow-2xl shadow-indigo-500/10 border border-slate-100 dark:border-slate-700 animate-in fade-in zoom-in duration-500">
                <div className="text-center mb-10">
                    <div className="w-16 h-16 bg-indigo-600 rounded-3xl mx-auto flex items-center justify-center text-white font-black text-3xl shadow-xl shadow-indigo-600/30 mb-6 font-sans">F.</div>
                    <h2 className="text-3xl font-black text-slate-800 dark:text-white">Créer un compte</h2>
                    <p className="text-slate-500 dark:text-slate-400 mt-2 font-medium">Commencez à gérer vos finances avec Fncly.</p>
                </div>
                ...
                <p className="text-center mt-10 text-slate-500 dark:text-slate-400 font-bold">
                    Déjà inscrit ?{" "}
                    <Link href="/login" className="text-indigo-600 dark:text-indigo-400 hover:underline underline-offset-4 decoration-2">
                        Se connecter
                    </Link>
                </p>
            </div>
